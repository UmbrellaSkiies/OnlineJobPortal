 ...
 */ !(function (e) {
  ...
  var i = function (e) {
    ...
    a = {
        ...
        i.length > 0 && !H(i) && (i = i.split(e.initialPreviewDelimiter)),
          (a.data[t] = {
            ...
            footer: e
              ...
              .replace(/\{progress\}/g, e.renderThumbProgress()),
      ...
      count: function (e, i) {
        return a.data[e] && a.data[e].content
          ? i
            ? a.data[e].content.length
            : a.fetch(e).length
          : 0
      },
      get: function (i, t, r) {
        ...
        return (
          ...
          null === s.content[t]
            ? ''
            : (Z(d) || Z(d.frameClass) || (p += ' ' + d.frameClass),
              (n = s.template
                .replace(/\{previewId\}/g, c)
                .replace(/\{frameClass\}/g, p)
                .replace(/\{fileindex\}/g, o)
                .replace(/\{content\}/g, s.content[t])
                .replace(/\{footer\}/g, a.footer(i, t, r))),
              s.tags.length && s.tags[t] && (n = K(n, s.tags[t])),
              Z(d) ||
                Z(d.frameAttr) ||
                ((l = e(document.createElement('div')).html(n)),
                l.find('.file-preview-initial').attr(d.frameAttr),
                (n = l.html()),
                l.remove()),
              n)
        )
      ...
      add: function (i, t, r, n, l) {
        var o,
          s = e.extend(!0, {}, a.data[i])
        return (
          H(t) || (t = t.split(s.delimiter)),
          l
            ? ((o = s.content.push(t) - 1), (s.config[o] = r), (s.tags[o] = n))
            : ((o = t.length), (s.content = t), (s.config = r), (s.tags = n)),
          (a.data[i] = s),
          o
        )
      },
      ...
      unset: function (e, i) {
        ...
        if (t) {
          if (1 === t)
            return (a.data[e].content = []), void (a.data[e].config = [])
      ...
      out: function (e) {
        ...
        return (i = r.msg(a.count(e))), { content: t, caption: i }
      },
      footer: function (e, i, t) {
        var r = a.data[e]
        if (
          ((t = void 0 === t ? !0 : t), 0 === r.config.length || Z(r.config[i]))
        )
          return ''
        var n = r.config[i],
    ...
    r = function (e, i) {
      return (
        ...
        'number' == typeof e
          ? e
          : ('string' == typeof e && (e = parseFloat(e)), isNaN(e) ? i : e)
      )
    },
    n = function () {
    ...
    x =
      '<div id="{id}" class="file-preview-detail-modal modal fade" tabindex="-1">\n  <div class="modal-dialog modal-lg">\n    <div class="modal-content">\n      <div class="modal-header">\n        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n        <h3 class="modal-title">{heading} <small>{title}</small></h3>\n      </div>\n      <div class="modal-body">\n           <pre>{body}</pre>\n      </div>\n    </div>\n  </div>\n</div>',
    T =
    ...
    D =
      ...
      '>\n   {footer}\n</div>\n',
    P =
      '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n   <pre class="file-preview-text" title="{caption}" ' +
      d +
      '>{data}</pre>\n   {zoom}\n   {footer}\n</div>',
    U =
      '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}" title="{caption}" ' +
      d +
    ...
    N = {
      ...
      text: function (e, i) {
        return (
          (void 0 !== e && e.match('text.*')) ||
          i.match(/\.(txt|md|csv|nfo|ini|json|php|js|css)$/i)
        )
      },
      video: function (e, i) {
        return (
          (void 0 !== e && e.match(/\.video\/(ogg|mp4|webm|3gp)$/i)) ||
          i.match(/\.(og?|mp4|webm|3gp)$/i)
        )
      },
      audio: function (e, i) {
        return (
          (void 0 !== e && e.match(/\.audio\/(ogg|mp3|wav)$/i)) ||
          i.match(/\.(ogg|mp3|wav)$/i)
        )
      },
      flash: function (e, i) {
        return (
          (void 0 !== e && 'application/x-shockwave-flash' === e) ||
          i.match(/\.(swf)$/i)
        )
      },
      object: function () {
    ...
    Z = function (i, t) {
      return (
        void 0 === i || null === i || 0 === i.length || (t && '' === e.trim(i))
      )
    },
    H = function (e) {
      return (
  ...
  ;(J.prototype = {
    ...
    validate: function () {
      var e,
        i = this
      return 'file' === i.$element.attr('type')
        ? !0
        : ((e =
    ...
    init: function (i) {
      ...
      e.each(i, function (e, i) {
        ...
        (n.fileBatchCompleted = !0),
        n.isPreviewable || (n.showPreview = !1),
        (n.uploadFileAttr = Z(d.attr('name')) ? 'file_data' : d.attr('name')),
        (n.reader = null),
        (n.formdata = {}),
        (n.filestack = []),
        (n.uploadCount = 0),
        ...
        (n.ajaxAborted = !1),
        (n.cancelling = !1),
        (t = n.getLayoutTemplate('progress')),
        (n.progressTemplate = t.replace('{class}', n.progressClass)),
        (n.progressCompleteTemplate = t.replace(
          '{class}',
          n.progressCompleteClass
        )),
        (n.dropZoneEnabled = l() && n.dropZoneEnabled),
        (n.isDisabled =
          n.$element.attr('disabled') || n.$element.attr('readonly')),
        (n.isUploadable = o() && !Z(n.uploadUrl)),
        (n.slug =
          'function' == typeof i.slugCallback ? i.slugCallback : n.slugDefault),
        (n.mainTemplate = n.getLayoutTemplate(
          n.showCaption ? 'main1' : 'main2'
        )),
        (n.captionTemplate = n.getLayoutTemplate('caption')),
        (n.previewGenericTemplate = n.getPreviewTemplate('generic')),
        Z(n.$element.attr('id')) && n.$element.attr('id', q()),
        void 0 === n.$container
          ? (n.$container = n.createContainer())
          : n.refreshContainer(),
        (n.$progress = n.$container.find('.kv-upload-progress')),
        (n.$btnUpload = n.$container.find('.fileinput-upload')),
        (n.$captionContainer = _(
          i,
          'elCaptionContainer',
          n.$container.find('.file-caption')
        )),
        (n.$caption = _(
          i,
          'elCaptionText',
          n.$container.find('.file-caption-name')
        )),
        (n.$previewContainer = _(
          i,
          'elPreviewContainer',
          n.$container.find('.file-preview')
        )),
        (n.$preview = _(
          i,
          'elPreviewImage',
          n.$container.find('.file-preview-thumbnails')
        )),
        (n.$previewStatus = _(
          i,
          'elPreviewStatus',
          n.$container.find('.file-preview-status')
        )),
        (n.$errorContainer = _(
          i,
          'elErrorContainer',
          n.$previewContainer.find('.kv-fileinput-error')
        )),
        Z(n.msgErrorClass) || s(n.$errorContainer, n.msgErrorClass),
        n.$errorContainer.hide(),
        (n.fileActionSettings = e.extend(u, i.fileActionSettings)),
        (n.previewInitId = 'preview-' + q()),
        (n.id = n.$element.attr('id')),
        a.init(n),
        n.initPreview(!0),
        n.initPreviewDeletes(),
        (n.options = i),
        n.setFileDropZoneTitle(),
        n.$element.removeClass('file-loading'),
        n.$element.attr('disabled') && n.disable()
    },
      ...
      var r = this,
        ...
        o =
          void 0 !== i.responseJSON && void 0 !== i.responseJSON.error
            ...
            : i.responseText
      return (
        r.cancelling && r.msgUploadAborted && (n = r.msgUploadAborted),
        r.showAjaxErrorDetails && o
          ? ((o = e.trim(o.replace(/\n\s*\n/g, '\n'))),
            (o = o.length > 0 ? '<pre>' + o + '</pre>' : ''),
            (n += l + o))
          : (n += l),
        (r.cancelling = !1),
        a ? '<b>' + a + ': </b>' + n : n
    ...
    raise: function (i, t) {
      var a = this,
        r = e.Event(i)
      if (
        (void 0 !== t ? a.$element.trigger(r, t) : a.$element.trigger(r),
      ...
      return (
        t &&
          ...
          r.previewFileIconSettings &&
            r.previewFileIconSettings[a] &&
            (n = r.previewFileIconSettings[a]),
          r.previewFileExtSettings &&
            e.each(r.previewFileExtSettings, function (e, i) {
              r.previewFileIconSettings[e] &&
                i(a) &&
                (n = r.previewFileIconSettings[e])
            })),
        i.indexOf('{previewFileIcon}') > -1
          ? i
              .replace(/\{previewFileIconClass\}/g, r.previewFileIconClass)
              .replace(/\{previewFileIcon\}/g, n)
          : i
      )
    },
    ...
    listen: function () {
      ...
      t(a, 'change', e.proxy(i.change, i)),
        ...
        t(i.$container.find('.fileinput-upload'), 'click', function (t) {
          var a,
            r = e(this),
            n = !r.hasClass('disabled') && Z(r.attr('disabled'))
          return i.isUploadable
            ? (t.preventDefault(), void (n && i.upload()))
            : void (
                n &&
                'submit' !== r.attr('type') &&
                ((a = r.closest('form')),
    ...
    submitForm: function () {
      ...
      return t &&
        e.minFileCount > 0 &&
        e.getFileCount(t.length) < e.minFileCount
        ? (e.noFilesError({}), !1)
        : !e.abort({})
    },
    abort: function (i) {
      ...
      return a.ajaxAborted &&
        ...
        ? ((t = e.extend(a.getOutData(), i)),
          (t.abortData = a.ajaxAborted.data || {}),
          (t.abortMessage = a.ajaxAborted.message),
          a.cancel(),
          a.setProgress(100),
    ...
    upload: function () {
      ...
      if (r.minFileCount > 0 && r.getFileCount(n) < r.minFileCount)
        return void r.noFilesError(l)
      if (r.isUploadable && !r.isDisabled && (0 !== n || o)) {
        if (
          ...
          return void r.uploadExtraOnly()
        if (
          ((a = r.filestack.length),
          (r.hasInitData = !1),
          r.uploadAsync && r.showPreview)
        )
          for (
            t = r.getOutData(),
              r.raise('filebatchpreupload', [t]),
              r.fileBatchCompleted = !1,
              r.uploadCache = { content: [], config: [], tags: [], append: !0 },
              i = 0;
            a > i;
            i += 1
          )
            void 0 !== r.filestack[i] && r.uploadSingle(i, r.filestack, !0)
        else r.uploadBatch()
      }
    },
    lock: function () {
      ...
      e.resetErrors(),
        ...
        e.showCancel &&
          e.$container.find('.fileinput-cancel').removeClass('hide'),
    ...
    unlock: function (e) {
      ...
      void 0 === e && (e = !0),
        ...
        i.showRemove &&
          i.$container.find('.fileinput-remove').removeClass('hide'),
        e && i.resetFileStack(),
    ...
    resetFileStack: function () {
      ...
      i.getThumbs().each(function () {
        ...
        ;-1 !== n &&
          (void 0 !== l
            ? ((a[t] = l),
              r.attr({ id: i.previewInitId + '-' + t, 'data-fileindex': t }),
              (t += 1))
            : r.attr({ id: 'uploaded-' + q(), 'data-fileindex': '-1' }))
      }),
        (i.filestack = a)
    },
    destroy: function () {
    ...
    initDragDrop: function () {
      ...
      t(
          ...
          return (
            ...
            i.isDisabled || !a
              ? ((t.originalEvent.dataTransfer.effectAllowed = 'none'),
                void (t.originalEvent.dataTransfer.dropEffect = 'none'))
              : void s(e(this), 'highlighted')
          )
        },
        !0
      ),
        t(a, 'dragleave', function (t) {
          t.stopPropagation(),
            t.preventDefault(),
        ...
        t(a, 'drop', function (t) {
          t.preventDefault(),
            i.isDisabled ||
              Z(t.originalEvent.dataTransfer.files) ||
              (i.change(t, 'dragdrop'), e(this).removeClass('highlighted'))
        }),
        t(
          e(document),
          r,
    ...
    setFileDropZoneTitle: function () {
      ...
      i.find('.' + e.dropZoneTitleClass).remove(),
        e.isUploadable &&
          e.showPreview &&
          0 !== i.length &&
          !(e.getFileStack().length > 0) &&
          e.dropZoneEnabled &&
          (0 === i.find('.file-preview-frame').length &&
            i.prepend(
              '<div class="' +
                e.dropZoneTitleClass +
                '">' +
                e.dropZoneTitle +
                '</div>'
            ),
          e.$container.removeClass('file-input-new'),
          s(e.$container, 'file-input-ajax-new'))
    },
    initFileActions: function () {
      ...
      i.$preview.find('.kv-file-remove').each(function () {
        ...
        t(s, 'click', function (t) {
          return (
            (o = i.raise('filepreremove', [c, p])),
            o !== !1 && i.validateMinCount()
              ? ((r = d.hasClass('file-preview-error')),
                i.cleanMemory(d),
                void d.fadeOut('slow', function () {
                  ;(i.filestack[p] = void 0),
                    i.clearObjects(d),
                    d.remove(),
                    c &&
                      r &&
                        ...
                        .fadeOut('fast', function () {
                          e(this).remove(),
                            i.$errorContainer.find('li').length ||
                              i.$preview.find(
                                '.file-preview-frame.file-preview-error'
                              ).length ||
                              i.resetErrors()
                        })
                  var t = i.getFileStack(!0),
                    ...
                    u =
                      i.showPreview &&
                      i.$preview.find('.file-preview-frame').length
                  i.clearFileInput(),
                    0 !== o || 0 !== s || u
                      ? ((n = s + o),
                        (l =
                          n > 1 ? i.getMsgSelected(n) : t[0] ? t[0].name : ''),
                        i.setCaption(l))
                      : i.reset(),
    ...
    renderFileFooter: function (e, i) {
      ...
      return (
        r.isUploadable
          ? ((t = l.replace(
              /\{actions\}/g,
              r.renderFileActions(!0, !0, !1, !1, !1)
            )),
            (a = t
              .replace(/\{caption\}/g, e)
              .replace(/\{width\}/g, i)
              .replace(/\{progress\}/g, r.renderThumbProgress())
              .replace(/\{indicator\}/g, n.indicatorNew)
              .replace(/\{indicatorTitle\}/g, n.indicatorNewTitle)))
          : (a = l
              .replace(/\{actions\}/g, '')
              .replace(/\{caption\}/g, e)
              .replace(/\{progress\}/g, '')
    ...
    renderFileActions: function (e, i, t, a, r) {
      ...
      return (
        (s = s
          .replace(/\{removeClass\}/g, f)
          .replace(/\{removeIcon\}/g, u.removeIcon)
          .replace(/\{removeTitle\}/g, u.removeTitle)
          .replace(/\{dataUrl\}/g, l)
          .replace(/\{dataKey\}/g, o)),
        e &&
          (d = n
            .getLayoutTemplate('actionUpload')
            .replace(/\{uploadClass\}/g, u.uploadClass)
            .replace(/\{uploadIcon\}/g, u.uploadIcon)
            .replace(/\{uploadTitle\}/g, u.uploadTitle)),
        c
          .replace(/\{delete\}/g, s)
          .replace(/\{upload\}/g, d)
          .replace(/\{other\}/g, p)
    ...
    clearPreview: function () {
      var e = this,
        i = e.$preview.find(
          e.showUploadedThumbs
            ? '.file-preview-frame:not(.file-preview-success)'
            : '.file-preview-frame'
        )
      i.remove(),
        (e.$preview.find('.file-preview-frame').length && e.showPreview) ||
          e.resetUpload()
    },
    initPreview: function (e) {
      ...
      return a.count(t.id)
        ? ((i = a.out(t.id)),
          (r = e && t.initialCaption ? t.initialCaption : i.caption),
          t.$preview.html(i.content),
          t.setCaption(r),
          void (Z(i.content) || t.$container.removeClass('file-input-new')))
        : (t.clearPreview(), void (e ? t.setCaption(r) : t.initCaption()))
    },
    initPreviewDeletes: function () {
      var i = this,
        r = i.deleteExtraData || {},
        n = function () {
          var e = i.isUploadable
            ? a.count(i.id)
            : i.$element.get(0).files.length
          0 !== i.$preview.find('.kv-file-remove').length ||
            e ||
            (i.reset(), (i.initialCaption = ''))
        }
      i.$preview.find('.kv-file-remove').each(function () {
        var l = e(this),
        ...
        if (!Z(o) && void 0 !== d) {
          var c,
            ...
            u,
            f,
            v = l.closest('.file-preview-frame'),
            g = a.data[i.id],
            m = v.data('fileindex')
          ;(m = parseInt(m.replace('init_', ''))),
            (u = Z(g.config) && Z(g.config[m]) ? null : g.config[m]),
            (f = Z(u) || Z(u.extra) ? r : u.extra),
            'function' == typeof f && (f = f()),
            (p = { id: l.attr('id'), key: d, extra: f }),
            (c = e.extend(
              {
                url: o,
                type: 'POST',
                dataType: 'json',
                data: e.extend({ key: d }, f),
                beforeSend: function (e) {
                  ;(i.ajaxAborted = !1),
                    i.raise('filepredelete', [d, e, f]),
                    i.ajaxAborted
                      ? e.abort()
                      : (s(v, 'file-uploading'), s(l, 'disabled'))
                },
                success: function (e, t, r) {
                  var o, s
                  return Z(e) || Z(e.error)
                    ? (a.unset(i.id, m),
                      (o = a.count(i.id)),
                      (s = o > 0 ? i.getMsgSelected(o) : ''),
                      i.raise('filedeleted', [d, r, f]),
                      i.setCaption(s),
                      v.removeClass('file-uploading').addClass('file-deleted'),
                      void v.fadeOut('slow', function () {
                        i.clearObjects(v),
                          v.remove(),
                          n(),
                          o ||
                            0 !== i.getFileStack().length ||
                            (i.setCaption(''), i.reset())
                      }))
                    : ((p.jqXHR = r),
                      (p.response = e),
                      i.showError(e.error, p, 'filedeleteerror'),
    ...
    clearFileInput: function () {
      ...
      Z(n.val()) ||
        (r.isIE9 || r.isIE10
          ? ((i = n.closest('form')),
            (t = e(document.createElement('form'))),
            (a = e(document.createElement('div'))),
            n.before(a),
            i.length ? i.after(t) : a.after(t),
            t.append(n).trigger('reset'),
            a.before(n).remove(),
            t.remove())
          : n.val(''),
      ...
      t.$btnUpload.removeAttr('disabled'),
        ...
        t.hasInitialPreview()
          ...
          : (t.getThumbs().each(function () {
            ...
            t.$preview.html(''),
            (i =
              !t.overwriteInitial && t.initialCaption.length > 0
                ? t.initialCaption
                : ''),
            t.setCaption(i),
            t.$caption.attr('title', ''),
            s(t.$container, 'file-input-new')),
        0 === t.$container.find('.file-preview-frame').length &&
          (t.initCaption() ||
    ...
    resetPreview: function () {
      ...
      a.count(t.id)
        ? ((e = a.out(t.id)),
          t.$preview.html(e.content),
          (i = t.initialCaption ? t.initialCaption : e.caption),
          t.setCaption(i))
        : (t.clearPreview(), t.initCaption())
    },
    resetPreviewThumbs: function (e) {
      var i,
        t = this
      return e
        ? (t.clearPreview(), void (t.filestack = []))
        : void (t.hasInitialPreview()
            ? ((i = a.out(t.id)),
              t.$preview.html(i.content),
              t.setCaption(i.caption),
              t.initPreviewDeletes())
            : t.clearPreview())
    },
    reset: function () {
      ...
      e.resetPreview(),
        ...
        (e.$preview.find('.file-preview-frame').length ||
          (e.isUploadable && e.dropZoneEnabled)) &&
          e.$container.removeClass('file-input-new'),
    ...
    getExtraData: function (e, i) {
      var t = this,
        a = t.uploadExtraData
      return (
        'function' == typeof t.uploadExtraData && (a = t.uploadExtraData(e, i)),
        a
      )
    },
          ...
          e.upload.addEventListener(
            ...
            function (e) {
              ...
              e.lengthComputable && (r = Math.ceil((n / l) * 100)),
                i
                  ? a.setAsyncUploadStatus(i, r, t)
                  : a.setProgress(Math.ceil(r))
            },
            !1
          ),
        e
    ...
    initUploadSuccess: function (i, t, r) {
      ...
      'object' != typeof i ||
        ...
        (void 0 !== i.initialPreview &&
          ...
          (n = void 0 === i.append || i.append ? !0 : !1),
          (u.overwriteInitial = !1),
          void 0 === t || r
            ? r
              ? (u.uploadCache.content.push(d[0]),
                u.uploadCache.config.push(c[0]),
                u.uploadCache.tags.push(p[0]),
                (u.uploadCache.append = n))
              : (a.set(u.id, d, c, p, n),
                u.initPreview(),
                u.initPreviewDeletes())
            : ((o = a.add(u.id, d, c[0], p[0], n)),
              (l = a.get(u.id, o, !1)),
              (s = e(l).hide()),
              t.after(s).fadeOut('slow', function () {
    ...
    initSuccessThumbs: function () {
      ...
      i.getThumbs('.file-preview-success').each(function () {
        ...
        r.removeAttr('disabled'),
          t(r, 'click', function () {
            var e = i.raise('filesuccessremove', [
              a.attr('id'),
              a.data('fileindex')
            ])
            i.cleanMemory(a),
      ...
      ;(f.formdata = g),
        ...
        0 === v ||
          ...
          ((l = function () {
            ...
            e.length > 0 ||
              f.fileBatchCompleted ||
              ((f.fileBatchCompleted = !0),
              setTimeout(function () {
                a.set(
                  f.id,
                  f.uploadCache.content,
                  f.uploadCache.config,
                  f.uploadCache.tags,
                  f.uploadCache.append
                ),
                  f.hasInitData && (f.initPreview(), f.initPreviewDeletes()),
                  f.unlock(),
                  f.clearFileInput(),
                  f.raise('filebatchuploadcomplete', [
                    f.filestack,
                    f.getExtraData()
                  ]),
                  (f.uploadCount = 0),
          ...
          (d = function (t) {
            ;(n = f.getOutData(t)),
              h.hasClass('file-preview-success') ||
                (f.setThumbStatus(h, 'Loading'), s(h, 'file-uploading')),
              w.attr('disabled', !0),
              b.attr('disabled', !0),
              r || f.lock(),
              f.raise('filepreupload', [n, m, i]),
              (x = e.extend(x, n)),
              f.abort(x) && (t.abort(), f.setProgress(100))
          }),
          (c = function (t, a, l) {
            ;(n = f.getOutData(l, t)),
              (x = e.extend(x, n)),
              setTimeout(function () {
                Z(t) || Z(t.error)
                  ? (f.setThumbStatus(h, 'Success'),
                    w.hide(),
                    (f.filestack[i] = void 0),
                    f.raise('fileuploaded', [n, m, i]),
                    f.initUploadSuccess(t, h, r),
                    r || f.resetFileStack())
                  : (f.setThumbStatus(h, 'Error'),
                    f.showUploadError(t.error, x))
              }, 100)
          }),
          (p = function () {
            setTimeout(function () {
          ...
          (u = function (a, n, l) {
            ...
            ;(f.uploadStatus[m] = 100),
              f.setThumbStatus(h, 'Error'),
              (x = e.extend(x, f.getOutData(a))),
              f.showUploadError(o, x)
          }),
          g.append(f.uploadFileAttr, t[i]),
          g.append('file_id', i),
          f.ajaxSubmit(d, c, p, u, m, i))
    },
      ...
      ;(l.formdata = new FormData()),
        0 !== d &&
            ...
            l.showPreview &&
              l.getThumbs().each(function () {
                ...
                i.hasClass('file-preview-success') ||
                  (l.setThumbStatus(i, 'Loading'), s(i, 'file-uploading')),
                  t.attr('disabled', !0),
                  a.attr('disabled', !0)
              }),
          ...
          (a = function (t, a, r) {
            ...
            Z(t) || Z(t.error)
              ? (l.raise('filebatchuploadsuccess', [n]),
                i(),
                l.showPreview
                  ? (o.each(function () {
                      var i = e(this),
              ...
              : (l.showPreview &&
                  (o.each(function () {
                    ...
                    return (
                      ...
                      t.removeAttr('disabled'),
                      0 === d.length
                        ? void l.setThumbStatus(i, 'Error')
                        : (-1 !== e.inArray(s, d)
                            ? l.setThumbStatus(i, 'Error')
                            : (i.find('.kv-file-upload').hide(),
                              l.setThumbStatus(i, 'Success'),
                              (l.filestack[s] = void 0)),
                          void s++)
                    )
                  }),
                  l.initUploadSuccess(t)),
                l.showUploadError(t.error, n, 'filebatchuploaderror'))
          }),
          (r = function () {
            l.setProgress(100),
              l.unlock(),
              l.initSuccessThumbs(),
              l.clearFileInput(),
              l.raise('filebatchuploadcomplete', [
                l.filestack,
                l.getExtraData()
              ])
          }),
          (n = function (i, t, a) {
            ...
            l.showUploadError(n, r, 'filebatchuploaderror'),
              ...
              l.showPreview &&
                ...
                l.getThumbs().removeClass('file-uploading'),
                l.getThumbs(' .kv-file-upload').removeAttr('disabled'),
                l.getThumbs(' .kv-file-delete').removeAttr('disabled'))
          }),
      ...
      ;(r.formdata = new FormData()),
        r.abort(n) ||
          ...
          (i = function (e, i, t) {
            ...
            Z(e) || Z(e.error)
              ? (r.raise('filebatchuploadsuccess', [a]),
                r.clearFileInput(),
                r.initUploadSuccess(e))
              : r.showUploadError(e.error, a, 'filebatchuploaderror')
          }),
          (t = function () {
            r.setProgress(100),
              r.unlock(),
              r.clearFileInput(),
              r.raise('filebatchuploadcomplete', [
                r.filestack,
                r.getExtraData()
              ])
          }),
    ...
    showFolderError: function (e) {
      var i = this,
        t = i.$errorContainer
      e &&
        (i.addError(i.msgFoldersNotAllowed.replace(/\{n\}/g, e)),
        t.fadeIn(800),
        s(i.$container, 'has-error'),
        i.raise('filefoldererror', [e]))
    },
    ...
    parseFileType: function (e) {
      ...
      for (r = 0; r < M.length; r += 1)
        if (
          ((a = M[r]),
          (i = W(a, n.fileTypeSettings) ? n.fileTypeSettings[a] : N[a]),
          (t = i(e.type, e.name) ? a : ''),
          !Z(t))
        )
          return t
    ...
    previewDefault: function (i, t, a) {
      if (this.showPreview) {
        ...
        a === !0 &&
          ...
          r.isUploadable ||
            (d +=
              '<div class="file-other-error" title="' +
              r.fileActionSettings.indicatorErrorTitle +
              '">' +
              r.fileActionSettings.indicatorError +
              '</div>')),
          r.$preview.append(
            '\n' +
              p
                .replace(/\{previewId\}/g, t)
                .replace(/\{frameClass\}/g, l)
                .replace(/\{fileindex\}/g, c)
                .replace(/\{caption\}/g, r.slug(i.name))
                .replace(/\{width\}/g, s.width)
                .replace(/\{height\}/g, s.height)
    ...
    previewFile: function (e, i, t, a, r) {
      if (this.showPreview) {
        ...
        g || h
          ? ((v = s.parseFilePreviewIcon(v, c.split('.').pop())),
            'text' === d
              ? ((l = V(t.target.result)),
                (o = 'text-' + q()),
                (n = v.replace(/\{zoom\}/g, s.getLayoutTemplate('zoom'))),
                (b = s
                  .getLayoutTemplate('modal')
                  .replace('{id}', o)
                  .replace(/\{title\}/g, p)
                  .replace(/\{body\}/g, l)
                  .replace(/\{heading\}/g, s.msgZoomModalHeading)),
                (n =
                  n
                    .replace(/\{previewId\}/g, a)
                    .replace(/\{caption\}/g, p)
                    .replace(/\{width\}/g, m.width)
                    .replace(/\{height\}/g, m.height)
                    .replace(/\{frameClass\}/g, '')
                    .replace(/\{zoomInd\}/g, s.zoomIndicator)
                    .replace(/\{footer\}/g, w)
                    .replace(/\{fileindex\}/g, C)
                    .replace(/\{type\}/g, i.type)
                    .replace(/\{zoomTitle\}/g, s.msgZoomTitle)
                    .replace(/\{dialog\}/g, "$('#" + o + "').modal('show')")
                    .replace(/\{data\}/g, l) + b))
              : (n = v
                  .replace(/\{previewId\}/g, a)
                  .replace(/\{caption\}/g, p)
                  ...
                  .replace(/\{data\}/g, r)),
            s.$preview.append('\n' + n),
            s.validateImage(e, a, p))
          : s.previewDefault(i, a)
      }
    },
    ...
    readFiles: function (i) {
      ...
      var t,
        ...
        g = function (r, n, l, o) {
          var s = e.extend(a.getOutData({}, {}, i), { id: l, index: o }),
            d = { id: l, index: o, file: n, files: i }
          return (
            a.previewDefault(n, l, !0),
            a.isUploadable && a.filestack.push(void 0),
      ...
      ;(t = function (e) {
        if ((Z(r.attr('multiple')) && (u = 1), e >= u))
          return (
            a.isUploadable && a.filestack.length > 0
              ? a.raise('filebatchselected', [a.getFileStack()])
              : a.raise('filebatchselected', [i]),
        ...
        var m,
          ...
          j = Z(U) ? '' : U.join(', ')
        if (
          (Z(U) || ($ = new RegExp('\\.(' + U.join('|') + ')$', 'i')),
          (k = k.toFixed(2)),
          a.maxFileSize > 0 && k > a.maxFileSize)
        )
          return (
            (b = a.msgSizeTooLarge
              .replace('{name}', E)
              .replace('{size}', k)
              .replace('{maxSize}', a.maxFileSize)),
            void (a.isError = g(b, F, y, e))
          )
        if (!Z(D) && H(D)) {
        ...
        return 0 !== S ||
          ...
          !H(U) ||
          Z($) ||
          ((x = E.match($)), (S += Z(x) ? 0 : x.length), 0 !== S)
          ? a.showPreview
            ? (n.length > 0 && void 0 !== FileReader
                ? (s.html(d.replace('{index}', e + 1).replace('{files}', u)),
                  o.addClass('loading'),
                  ...
                  (m = W('text', f) ? f.text : N.text),
                  m(F.type, E)
                    ? l.readAsText(F, a.textEncoding)
                    : l.readAsArrayBuffer(F))
                : (a.previewDefault(F, y),
                  setTimeout(function () {
                    t(e + 1), a.updateFileDetails(u)
                  }, 100),
                  a.raise('fileloaded', [F, y, e, l])),
              void a.filestack.push(F))
            : (a.filestack.push(F),
              setTimeout(t(e + 1), 100),
              void a.raise('fileloaded', [F, y, e, l]))
          : ((b = a.msgInvalidFileExtension
              .replace('{name}', E)
              .replace('{extensions}', j)),
            void (a.isError = g(b, F, y, e)))
      }),
        t(0),
    ...
    updateFileDetails: function (e) {
      ...
      i.isError
        ? (i.$previewContainer.removeClass('loading'),
    ...
    validateMinCount: function () {
      ...
      return e.validateInitialCount &&
        e.minFileCount > 0 &&
        e.getFileCount(i - 1) < e.minFileCount
        ? (e.noFilesError({}), !1)
        : !0
    },
    ...
    change: function (i) {
      var t = this,
        r = t.$element
      if (!t.isUploadable && Z(r.val()) && t.fileInputCleared)
        return void (t.fileInputCleared = !1)
      ...
      if (
        ...
        for (n = []; u[v]; )
          (s = u[v]), s.type || s.size % 4096 !== 0 ? n.push(s) : g++, v++
      else
        n =
          void 0 === i.target.files
      ...
      if (Z(n) || 0 === n.length)
        return (
          h || t.clear(), t.showFolderError(g), void t.raise('fileselectnone')
        )
      if (
        (t.resetErrors(),
        (c = n.length),
        (o = t.isUploadable ? t.getFileStack().length + c : c),
        (o = t.getFileCount(o)),
        t.maxFileCount > 0 && o > t.maxFileCount)
      ) {
        if (!t.autoReplace || c > t.maxFileCount)
          return (
            (d = t.autoReplace && c > t.maxFileCount ? c : o),
            (l = t.msgFilesTooMany
              .replace('{m}', t.maxFileCount)
              .replace('{n}', d)),
        ...
        !h || w
          ? (t.resetPreviewThumbs(!1), w && (t.filestack = []))
          : !h ||
            0 !== m ||
            (a.count(t.id) && !t.overwriteInitial) ||
            t.resetPreviewThumbs(!0)
      ...
      ;(a = a || 'Untitled'),
        c.length &&
          t(c, 'load', function () {
            ;(n = d.width()),
              (l = s.width()),
              n > l && (c.css('width', '100%'), d.css('width', '97%')),
              (r = { ind: e, id: i }),
              o.checkDimensions(e, 'Small', c, d, a, 'Width', r),
              o.checkDimensions(e, 'Small', c, d, a, 'Height', r),
              o.checkDimensions(e, 'Large', c, d, a, 'Width', r),
              o.checkDimensions(e, 'Large', c, d, a, 'Height', r),
              o.raise('fileimageloaded', [i]),
      ...
      !Z(f) &&
        ...
        c ||
          ((o = p['msgImage' + n + i]
            .replace('{name}', r)
            .replace('{size}', f)),
          p.showUploadError(o, l),
          p.setThumbStatus(a, 'Error'),
          (p.filestack[e] = null)))
    },
    initCaption: function () {
      var e = this,
        i = e.initialCaption || ''
      return e.overwriteInitial || Z(i)
        ? (e.$caption.html(''), !1)
        : (e.setCaption(i), !0)
    },
    setCaption: function (i, t) {
      var a,
        ...
        n = this
      if (t)
        (a = e('<div>' + n.msgValidationError + '</div>').text()),
          (r =
            '<span class="' +
            n.msgValidationErrorClass +
            '">' +
            n.msgValidationErrorIcon +
            a +
            '</span>')
      else {
    ...
    renderMain: function () {
      var e = this,
        ...
        t = e.showPreview
          ? e
              .getLayoutTemplate('preview')
              .replace(/\{class\}/g, e.previewClass)
              .replace(/\{dropClass\}/g, i)
          : '',
        a = e.isDisabled
      ...
      return e.mainTemplate
        ...
        .replace(/\{preview\}/g, t)
        .replace(/\{caption\}/g, r)
        .replace(/\{upload\}/g, e.renderButton('upload'))
        .replace(/\{remove\}/g, e.renderButton('remove'))
        .replace(/\{cancel\}/g, e.renderButton('cancel'))
        .replace(/\{browse\}/g, e.renderButton('browse'))
    },
    renderButton: function (e) {
      ...
      switch (e) {
        ...
        case 'upload':
          ...
          i.isUploadable && !i.isDisabled
            ? (t = i
                .getLayoutTemplate('btnLink')
      ...
      if (n() || i(9)) {
        ...
        switch (
          ...
          this.each(function () {
            ...
            l ||
              ((i = e.extend({}, e.fn.fileinput.defaults)),
              'en' === s ||
                Z(e.fn.fileinputLocales[s]) ||
                (i = e.extend(i, e.fn.fileinputLocales[s])),
              (l = new J(this, e.extend(i, o, n.data()))),
              n.data('fileinput', l)),
