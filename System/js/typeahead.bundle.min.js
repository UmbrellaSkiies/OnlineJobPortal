...
!(function (a) {
  var b = {
        ...
        b.mixin(a.prototype, {
          set: function (a, b) {
            ...
            this.size >= this.maxSize &&
              (this.list.remove(e), delete this.hash[e.key]),
              (c = this.hash[a])
    ...
    f = (function () {
      function c (b) {
        ;(b = b || {}),
          (this._send = b.transport ? e(b.transport) : a.ajax),
        ...
        b.mixin(c.prototype, {
          _get: function (a, b, c) {
            ...
            ;(j = g[a])
              ? j.done(d)
              : h > f
              ? (f++, (g[a] = this._send(a, b).done(d).always(e)))
    ...
    g = (function () {
      ...
      function g (a, b) {
        ...
        var d = 0,
          e = 0,
          f = []
        for (a = a.sort(c), b = b.sort(c); d < a.length && e < b.length; )
        ...
        return (
          ...
          b.mixin(c.prototype, {
            ...
            _readFromStorage: function (a) {
              ...
              return (
                this.storage &&
                  ((c.data = this.storage.get(j.data)),
                  (c.protocol = this.storage.get(j.protocol)),
                  (c.thumbprint = this.storage.get(j.thumbprint))),
  ...
  b.isMsie() &&
    ...
    b.isMsie() && b.isMsie() <= 7 && b.mixin(j.input, { marginTop: '-1px' })
  var k = (function () {
      function c (b) {
    ...
    m = (function (a) {
      ...
      return function (e) {
        function f (b) {
          ...
          return (
            (c = h.exec(b.data)) &&
              ((wrapperNode = a.createElement(e.tagName)),
          ...
          _checkInputValue: function () {
            ...
            ;(a = this.getInputValue()),
              ...
              b
                ...
                : this.trigger('queryChanged', (this.query = a))
          },
          focus: function () {
            this.$input.focus()
          },
          ...
          _render: function (c, d) {
            ...
            function f () {
              function e (b) {
                var c, d, e
                return (
                  (d = p.templates.suggestion(b)),
                  (e = i.suggestion.replace('%BODY%', d)),
                  (c = a(e).data(g, p.name).data(h, p.displayFn(b)).data(k, b)),
              ...
              var f, l
              return (
                (f = a(i.suggestions).css(j.suggestions)),
                (l = b.map(d, e)),
                f.append.apply(f, l),
                p.highlight && m({ node: f[0], pattern: c }),
                f
              )
            }
            function l () {
    ...
    q = (function () {
      function c (c) {
        ...
        ;(c = c || {}),
          ...
          (this.eventBus = c.eventBus || new k({ el: f })),
          (this.dropdown = new p({ menu: e, datasets: c.datasets })
          ...
          (this.input = new n({ input: f, hint: g })
          ...
          e.on('mousedown.tt', function (a) {
            b.isMsie() &&
              b.isMsie() < 9 &&
              (f[0].onbeforedeactivate = function () {
