...
<head>
	...
	<title>Pay Day - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Johanessburg <br/> 19 Ameshoff Street <br/>Braamfontein</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:pay.day@gmail.com">pay.day@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+233 546 607 474">+2772 915 3977</a>
								</li>
