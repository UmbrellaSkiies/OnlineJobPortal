...
<head>
	...
	<title>Pay Day - Job Portal</title>
    ...
    <meta property="og:image:alt" content="Pay day" />
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<h1>Tsoga ke Nako</h1>
					<p>Find your next job in a matter of seconds with just a few clicks</p>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5>Step 2: Apply for your dream Job</h5>
									</div>
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5>Step 3: Wake up and go to Work</h5>
									</div>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Pay Day</h5>
											<p>Pay Day is a job portal and online job management system developed by The Matrix.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Pay Day Contact</h5>
								
								<p>Address : Johanessburg, 19 Ameshoff Street Braamfontein</p>
								<p>Email : <a href="mailto:pay.day@gmail.com">pay.day@gmail.com</a></p>
								<p>Phone : <a href="tel:+27729153977">+2772 915 3977</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> The Matrix Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by The Matrix</a></li>
								</ul>
